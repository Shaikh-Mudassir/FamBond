import {EditOutlined,
    DeleteOutlined,
    AttachFileOutlined, GifBoxOutlined,ImageOutlined, MicOutlined, MoreHorizOutlined   
     ...
     return(
        <WidgetWrapper>
            ...
            <FlexBetween>
                ...
                <Button disabled =  {!post} onClick={handlePost} sx={{color: theme.palette.background.alt, backgroundColor: theme.palette.primary.main,
                     borderRadius: "3rem"}}>POST</Button>
            </FlexBetween>
